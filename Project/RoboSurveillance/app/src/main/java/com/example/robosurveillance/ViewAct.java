...
public class ViewAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(ViewAct.this, "error in connection ", Toast.LENGTH_SHORT).show();
                }
        ...
        playBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(ViewAct.this, e.getMessage()+"playBtn", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        sendCmdBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Toast.makeText(ViewAct.this, e.getMessage() + "sendBtn", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public class ClientThread implements Runnable {
        ...
        public void run() {
            ...
            {
                Toast.makeText(ViewAct.this, "error in connection of receiving", Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        }
    }
        ...
        protected Void doInBackground(Void... voids)
        {
            ...
            while(true)
            {
                ...
                try {
                    ...
                    Toast.makeText(ViewAct.this, e.getMessage()+"input vali", Toast.LENGTH_LONG).show();
                    e.printStackTrace();
                }
                ...
                catch (Exception e)
                {
                    handler.post(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(ViewAct.this, "IllegalStateException cannot decode", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                ...
                if(bitim==null)
                {
                    try{
                        ...
                        handler.post(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(ViewAct.this, "null object", Toast.LENGTH_SHORT).show();
                            }
                        });
                    ...
                    }catch (Exception e)
                    {
                        handler.post(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(ViewAct.this, "width = ", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }
                ...
                public void run()
                {
                    ...
                    catch (Exception e)
                    {
                        handler.post(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(ViewAct.this, "this frame was null", Toast.LENGTH_SHORT).show();
